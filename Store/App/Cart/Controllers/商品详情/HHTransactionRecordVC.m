...
- (void)viewDidLoad {
    ...
    //tableView
    CGFloat tableHeight;
    tableHeight = SCREEN_HEIGHT - 64 - 40;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    HHGoodDealRecordInfoDetailCell *cell = (HHGoodDealRecordInfoDetailCell *)[[[NSBundle mainBundle] loadNibNamed:HHGoodDealRecordInfoDetailCellID owner:nil options:nil] firstObject];
