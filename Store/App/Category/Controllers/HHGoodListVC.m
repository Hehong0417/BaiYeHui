...
- (void)getDatas{
  ...
  self.sessionTask = [[[HHCategoryAPI GetProductListWithType:self.type categoryId:self.categoryId name:self.name orderby:self.orderby page:@(self.page) pageSize:@(self.pageSize)] netWorkClient] getRequestInView:nil finishedBlock:^(HHCategoryAPI *api, NSError *error) {
