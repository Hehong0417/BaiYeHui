...
#import "HHStoreProtocolVC.h"
#import "HHBorrow_integralProtocolVC.h"
#import "HHContractManagerVC.h"
#import "HHTeamListVC.h"

@interface HHAdvancedCooperationVC ()<UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate>
{
...
@implementation HHAdvancedCooperationVC
...
- (void)viewDidLoad {
    ...
    NSMutableAttributedString *attrStr = [NSString lh_attriStrWithprotocolStr:@"《社区体验店协议》" content:@"  同意注册协议《社区体验店协议》" protocolFont:FONT(12) contentFont:FONT(12) protocolStrColor:APP_purple_Color contentColor:KTitleLabelColor];
...
//    protocolBtn.hidden = YES;
    ...
    [protocolBtn.titleLabel setTapActionWithBlock:^{
        HHStoreProtocolVC *vc = [[HHStoreProtocolVC alloc] initWithNibName:@"HHStoreProtocolVC" bundle:nil];
    ...
    [borrow_integral_btn setContentEdgeInsets:UIEdgeInsetsMake(0, -WidthScaleSize_H(24), 0, 0)];
...
- (void)saveBtnAction:(UIButton *)btn{
    ...
    if (!validStr) {
        ...
        UIAlertAction *action1 = [UIAlertAction actionWithTitle:@"确定" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
            ...
            [[ [HHMineAPI postSignWithtype:@"2" parentId:parentIdCell.inputTextField.text isBorrowIntegral:isBorrowIntegral shopsId:shopsIdCell.inputTextField.text] netWorkClient] postRequestInView:self.view finishedBlock:^(HHMineAPI *api, NSError *error) {
