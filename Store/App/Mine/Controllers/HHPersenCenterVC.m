...
- (NSArray *)groupTitles{
    ...
    if ([self.mineModel.level isEqualToString:@"3"]) {
        //体验店
        return @[@[@""],@[@"账户信息",@"我的订单",@"我的钱包",@"成功分享数量",@"促销限购资格数",@"配额数量"],@[@"体验店店补",@"体验店配额",@"体验店二维码"]];

    }else  {
        //
        return @[@[@""],@[@"账户信息",@"我的订单",@"我的钱包",@"成功分享数量",@"配额数量"]];
...
- (NSArray *)groupIcons {
    ...
    if ([self.mineModel.level isEqualToString:@"3"]) {
        //体验店
        return @[@[@""],@[@"icon_users_user_default",@"icon_lists_user_default",@"icon_wallet_user_default",@"icon_lshare_user_default",@"qualification",@"icon_clock_user_default"],@[@"icon_shops_user_default",@"icon_allot_user_default",@"icon_qrcodes_user_default"]];

    }else  {
        //
        return @[@[@""],@[@"icon_users_user_default",@"icon_lists_user_default",@"icon_wallet_user_default",@"icon_lshare_user_default",@"icon_clock_user_default"]];

    }
    
    return @[@[@""],@[@"icon_users_user_default",@"icon_lists_user_default",@"icon_wallet_user_default",@"icon_lshare_user_default",@"qualification",@"icon_clock_user_default"]];
