...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    if (section == 1) {
        ...
        UILabel *lab = [UILabel lh_labelWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 50) text:@"提款手续费为3%，提现三到五个工作日到账" textColor:KACLabelColor font:FONT(13) textAlignment:NSTextAlignmentCenter backgroundColor:KVCBackGroundColor];
        return lab;
