...
- (void)viewDidLoad{
    ...
    UIView *nav = [[UIView alloc]initWithFrame:CGRectMake(0, 0,ScreenW, h)];
    ...
    //扫一扫
    XYQButton *swapBtn = [XYQButton ButtonWithFrame:CGRectMake(0,y, 40, 40) imgaeName:@"qiehuan" titleName:@"切换" contentType:TopImageBottomTitle buttonFontAttributes:[FontAttributes fontAttributesWithFontColor:KLightTitleColor fontsize:8] title_image_padding:5 tapAction:^(XYQButton *button) {
        [self swapAction];
    }];
    swapBtn.centerX = 40;
    [nav addSubview:swapBtn];
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath{
        ...
        return CGSizeMake((SCREEN_WIDTH-2)/2 , 80+2+(SCREEN_WIDTH - 2)/2);
...
- (void)cycleScrollView:(SDCycleScrollView *)cycleScrollView didSelectItemAtIndex:(NSInteger)index{
    ...
    HHWebViewVC *vc = [HHWebViewVC new];
